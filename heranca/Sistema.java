...
public class Sistema {
   public static void main(String[] args) {
    Engenheiro eng1 = new Engenheiro("Joao", 123, 123, "crea1", "Orientacao a objetos", 100000.0);
    Engenheiro eng2 = new Engenheiro("Pedro", 124, 124, "crea2", "Orientacao a objetos", 150000.0);
